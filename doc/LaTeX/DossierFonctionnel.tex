...
\section{Modèle de Donnés}

Le modèle de donnés est une façon abstraite de représenter les donnés du système et de modéliser les informations contenus dans une base de donnés. Le modèle constitue des ensembles possèdent d'un nom et des attributs nommés. La  des relations est fait via des clés primaires (id, dans notre cas) et des clés étrangères.  
...
\caption{\label{fig:UML} Modèle de donnés pour le système BMONS}
\end{figure}
...
\begin{figure}[h!]
\centering\includegraphics[scale=0.7]{recupererMemoireFlash.jpeg}
\caption{\label{fig:sp_comp} Diagramme de spécification des comportements}
\end{figure}
\begin{figure}[h!]
\centering\includegraphics[scale=0.7]{analyserInformation.jpeg}
\caption{\label{fig:sp_comp} Diagramme de spécification des comportements}
\end{figure}
\begin{figure}[h!]
\centering\includegraphics[scale=0.7]{avertirOperationRuche.jpeg}
\caption{\label{fig:sp_comp} Diagramme de spécification des comportements}
\end{figure}
\begin{figure}[h!]
\centering\includegraphics[scale=0.7]{configurerAlerte.jpeg}
\caption{\label{fig:sp_comp} Diagramme de spécification des comportements}
\end{figure}
\begin{figure}[h!]
\centering\includegraphics[scale=0.7]{IdentificationCompte.jpeg}
\caption{\label{fig:sp_comp} Diagramme de spécification des comportements}
\end{figure}
\pagebreak
