...
Le diagramme des données est décris dans la figure 

\begin{figure}[h!]
\centering\includegraphics[scale=0.6]{diagFluxDonnees.pdf}
\caption{\label{fig:fast} Diagramme d'activité du flux de données}
\end{figure}
