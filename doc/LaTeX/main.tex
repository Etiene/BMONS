...
\begin{figure}[h!]
\centering\includegraphics[scale=0.60]{axisData1.png}
\caption{\label{fig:axeData1} Axe Data (1/3)}
\end{figure}

\begin{figure}[h!]
\centering\includegraphics[scale=0.60]{axisData2.png}
\caption{\label{fig:axeData2} Axe Data (2/3)}
\end{figure}

\begin{figure}[h!]
\centering\includegraphics[trim = 4.5cm 0cm 0cm 0cm,scale=0.60]{axisData3.png}
...
\begin{figure}[h]
\centering\includegraphics[trim = 4.0cm 0cm 0cm 0cm,scale=0.65]{analyseFonctionelle1.pdf}
