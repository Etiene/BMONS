...
\begin{figure}[h]
\centering\includegraphics[scale=1]{virtualbox.png}
\caption{\label{fig:virtualbox} Oracle VM VirtualBox Software}
\end{figure}

\begin{figure}[h]
\centering\includegraphics[scale=1]{ubuntu.png}
